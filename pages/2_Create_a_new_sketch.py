...
if img is None:
    ...
    with st.spinner('Wait for it...'):
        ...
        array_white = np.abs(array_255 - final_array)

        final_img_white = np.array(array_white).reshape(w, h)
        plt.imsave('final_white_sketch.jpeg', final_img_white, cmap=cm.gray)
